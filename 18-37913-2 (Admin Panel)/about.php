...
<div class="row">
    <div class="column">
        <div class="card">
            <img src="MyPic.jpg" alt="Ankur" style="width:100%; height: 400px;">
            <div class="container">
                <h2>Ankur Saha</h2>
    ...
    <div class="column">
        <div class="card">
            <img src="MyPic1.jpg" alt="Pulok" style="width:100%;  height: 400px;">
            <div class="container">
                <h2>Pulok Rehan</h2>
                <p class="title">Founder</p>
    ...
    <div class="column">
        <div class="card">
            <img src="MyPic2.jpg" alt="Sazid" style="width:100%; height: 400px;">
            <div class="container">
                <h2>Sazid Ahmed</h2>
                <p class="title">Founder</p>
